...
//       ],
//       [wrapped?.equals(TOKA) ? undefined : wrapped, chainId === ChainId.MAINNET ? TOKA : undefined],
//       [chainId ? WETH[chainId] : undefined, chainId === ChainId.MAINNET ? TOKA : undefined]
//     ],
...
//         return new Price(currency, TOKA, price.denominator, price.numerator)
//       } else {
//         return undefined
//       }
//     }
//     // handle usdc
//     if (wrapped.equals(TOKA)) {
